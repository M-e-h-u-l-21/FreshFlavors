...
import com.example.foody.util.Constants.Companion.PREFERENCES_BACKONLINE
...
class DataStoreRepository @Inject constructor(
    ...
    private object PreferenceKeys{
        ...
        val selectedMealType = stringPreferencesKey(PREFERENCES_MEAL_TYPE) // Just defining key
        val selectedMealTypeId= intPreferencesKey(PREFERENCES_MEAL_TYPE_ID)

        val selectedDietType = stringPreferencesKey(PREFERENCES_DIET_TYPE)
        val selectedDietTypeId = intPreferencesKey(PREFERENCES_DIET_TYPE_ID)

        val backOnline = booleanPreferencesKey(PREFERENCES_BACKONLINE)
